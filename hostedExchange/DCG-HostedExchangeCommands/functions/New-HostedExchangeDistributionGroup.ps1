...
New-DistributionGroup -DisplayName "$companyName - $friendlyName" -Alias $emailPrefix -OrganizationalUnit $ouOfGroups -ModeratedBy $distGroupOwner -CopyOwnerToMember $True 
...
Write-Host "Group created. Please create the group on Reflexion and add any other members to it." -ForegroundColor Yellow -BackgroundColor Red