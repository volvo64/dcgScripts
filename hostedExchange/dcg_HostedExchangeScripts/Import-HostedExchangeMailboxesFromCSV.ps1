...
Import-csv $csv |Foreach {Add-MailboxPermission $_.UserPrincipalName -User Administrator@hosted1.local -AccessRight FullAccess -InheritanceType All -Automapping $false}